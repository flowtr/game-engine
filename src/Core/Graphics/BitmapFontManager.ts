...
export type IBitmapFontConfigSerilization<E = Record<string, unknown>> = E & {
    name: String;
    fontFile: string;
};
...
class BitmapFontConfig {
    ...
    public static fromJson(
        json: IBitmapFontConfigSerilization
    ): BitmapFontConfig {
        ...
        if (json.name !== undefined) {
            ...
            if (json.fontFile !== undefined)
                ...
                throw new Error(
                    "Cannot create a bitmap font without a font file."
                );
...
export class BitmapFontManager {
    ...
    public static load(): void {
        ...
        if (asset !== undefined) BitmapFontManager.processFontAsset(asset);
