...
import { GLBuffer, AttributeInfo, Matrix4x4 } from "..";
...
export class Sprite {
    ...
    protected _origin: Tensor<Vector> = Tensor.zeros([3]);
    ...
    public get origin(): Tensor<Vector> {
        return this._origin;
    }

    /** The name of this sprite. */
    public set origin(value: Tensor<Vector>) {
        this._origin = value;
    ...
    protected recalculateVertices(): void {
        ...
        for (let v of this._vertices) this._buffer.pushBackData(v.toArray());
