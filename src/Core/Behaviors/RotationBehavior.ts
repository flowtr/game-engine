...
import { IBehaviorBuilder, IBehavior, BaseBehavior, BehaviorManager } from ".";
import { IBehaviorData } from "./IBehaviorData";

export type RotationBehaviorDataSerialization<
    E = Record<string, unknown>
> = E & { name: string; rotation: number[] };
/**
...
export class RotationBehaviorData implements IBehaviorData {
    ...
    public rotation: Tensor<Vector> = Tensor.zeros([3]);

    /**
     * Sets the properties of this data from the provided json.
     * @param json The json to set from.
     */
    public setFromJson(json: RotationBehaviorDataSerialization): void {
...
export class RotationBehavior extends BaseBehavior {
    private _rotation: Tensor<Vector>;
