...
export class InputManager {
    ...
    private static _resolutionScale: Tensor<[2]> = Tensor.fill([2], 1);
    ...
    public static getMousePosition(): Tensor<[2]> {
        return Tensor.from(this._mouseX, this._mouseY);
    }

    /** Gets the current mouse position. */
    public static getPreviousMousePosition(): Tensor<[2]> {
        return Tensor.from(this._previousMouseX, this._previousMouseY);
    }
     ...
     */
    public static setResolutionScale(scale: Tensor<[2]>): void {
        InputManager._resolutionScale = scale.clone();
    }
